...
gconftool-2 --set "/apps/gnome-terminal/profiles/$profile/background_color" --type string "$BG_COLOR"
gconftool-2 --set "/apps/gnome-terminal/profiles/$profile/foreground_color" --type string "$FG_COLOR"
